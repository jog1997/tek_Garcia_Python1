...
You could write a loop that looks at each pixel in a row and, inside that loop, add a second loop that looks at every pixel in the current column for that row.
'''
...
mixed_array = ["Hello", 42, True, "Last"]
print(mixed_array)

# Iterate through this list using for loop and see the output.
for index in range(len(mixed_array) - 1, -1, -1):
    print(mixed_array[index])
...
''' start with a string of numbers to reverse the string. Then change it back to an integer.'''
y = "1234"
x = y[::-1]
type(int(x))
print(x)
...
print(Favorite_Food)
Favorite_Heroes = ['Spider-man', 'Batman', 'Superman', 'Green Arrow']
print(Favorite_Heroes)
Favorite_Desserts = ['cheesecake', 'ice cream', 'coffee', 'cupcakes']
print(Favorite_Desserts)
Gym_Equipment = ['towel', 'water bottle', 'earphones', 'Fitbit', 'keys']
print(Gym_Equipment)

# 5 Dictionaries
Places_to_Visit = {"America": "California", "Mexico": "Mexico City", "Canada": "Toronto", "France": "Paris", "Britain":
    "London"}
print(Places_to_Visit)

Model_Type_Car_dict = {"Honda": "Accord", "Volkswagen": "Jetta", "Toyota": "Corrolla", "Audi":
                        "R8", "Ford": "Mustang"}
print(Model_Type_Car_dict)

Comic_superhero_dict = {"Marvel": "Spider-man, Captain America, Hawkeye, Iron Man", "DC": "Batman, Superman, Wonderwoman"}
print(Comic_superhero_dict)

Cuisine_Dish_dict = {"American": "Burgers", "Japanese": "Ramen", "Chineese": "Sweet and Sour Chicken", "Greek":
                        "Gyros"}
print(Cuisine_Dish_dict)
Location_of_Friends_dict = {"Josh": "Austin, Texas", "Juan": "Fort Worth, Texas", "Ivan": "San Antonio, Texas", "David":
                        "Rio Grande, Texas", "Luis": "College Station, Texas"}
print(Location_of_Friends_dict)